...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #748E63;">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('tatausaha')}}">
                <div class="sidebar-brand-text mx-3"><img class="logo3 mt-5" src="{{ asset('assets/img/logo.png') }}"  height="80" width="90" alt=""> </div>
            </a>
<br>
            <!-- Nav Item - Dashboard -->
            <li class="nav-item active">
                <a class="nav-link" href="{{route('tatausaha')}}">
             ...
             <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('daftarkelassiswa')}}">SISWA</a>
                        <a class="collapse-item" href="{{route('daftarptk')}}">PTK</a>
                        <a class="collapse-item" href="{{route('daftartu')}}">Tata Usaha</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nilai -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('listraporsiswa')}}"  data-target="#collapseTwo"
             ...
             <!-- Jadwal -->
             <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('daftarkelassiswaJS')}}"  data-target="#collapseTwo"
                     aria-expanded="true" aria-controls="collapseTwo">
           ...
           <li class="nav-item">
            ...
            <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('daftarekskul')}}">Daftar Ekstrakurikuler</a>
                    <a class="collapse-item" href="{{route('daftarekskulsiswa')}}">Ekstrakurikuler Siswa</a>
                </div>
            </div>
             ...
             <!-- Profile -->
             <li class="nav-item">
                 <a class="nav-link collapsed" href="{{route('audit')}}"  data-target="#collapsePages"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('profileadmin')}}"  data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
