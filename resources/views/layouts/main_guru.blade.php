...
<br>
            ...
            <!-- Jadwal -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('jadwalmengajar')}}"  data-target="#collapseTwo"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('profilelengkap')}}"  data-target="#collapsePages"
