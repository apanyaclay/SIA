...
<br>
            ...
            <!-- Jadwal -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('jadwal')}}"  data-target="#collapseTwo"
            ...
            <!-- Rapor-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('rapor')}}"  data-target="#collapseUtilities"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('profile')}}"  data-target="#collapsePages"
