...
@section('container')
<div class="edit text-sm-end"><a  type="button" class="btn btn-secondary mt-3 mb-3"  href="{{route('tambahkelassadmin')}}"><i class="fa-solid fa-file-pen" style="color: #ffffff;"></i> Tambah  Kelas</a></div>
