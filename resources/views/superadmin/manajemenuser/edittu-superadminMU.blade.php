...
@section('container')
    ...
    <!-- Page Heading -->
    <h1 class="jadwal h3 mb-0 text-gray-800" style="font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif; text-align: center;"> Tambah  Pegawai Tata Usaha </h1>
          ...
          @csrf
            <table class="table mt-4">
                ...
                <div class="form-group">
                   ...
                   <td><input type="text"  id="id" name="id" required readonly value="{{$item->ID_Pegawai}}"></td> 
                    </tr>
                </div>
                <div class="form-group">
                  <tr>
                 <th><label for="nama">Nama:</label></th> 
                 <td><input type="text"  id="nama" name="nama" required value="{{$item->Nama_Pegawai}}"></td> 
                  </tr>
              </div>
                <div class="form-group">
                    <tr>
