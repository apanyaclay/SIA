...
@section('container')
    <div class="edit text-sm-end"><a href="{{ route('tambahptk') }}" type="button" class="btn btn-secondary mt-3 mb-3"><i
            ...
            <tbody>
                <tr>
                    @foreach ($ptk as $ptklist)
                        ...
                        <td><a type="button" href="{{ url('superadmin/detailptk', $ptklist->NUPTK) }}"
