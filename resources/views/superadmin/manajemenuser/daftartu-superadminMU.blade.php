...
@section('container')
    <div class="edit text-sm-end"><a type="button" href="{{ route('tambahtu') }}" class="btn btn-secondary mt-3 mb-3"><i
            ...
            <tbody>
                @foreach ($tu as $tulist)
                    <tr>
                        ...
                        <td><a type="button" href="{{ url('superadmin/detailtu', $tulist->ID_Pegawai) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/superadmin/deletetu/' + ekskulId;
            });
        });
    </script>
@endsection
