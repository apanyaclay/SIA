...
@section('container')
   ...
   <br>
   <div class="tablewali">
      <form action="{{route('editekskulsiswaPost')}}" method="POST">
        @csrf
            @foreach ($hasil as $item)
            <div class="form-group">
                <label for="kode">Kode</label>
                <input type="text" class="form-control" id="kode" name="kode" value="{{$item->ID_Ekskul_Siswa}}" readonly>
            </div>
            <div class="form-group">
                <label for="nama">NAMA</label>
                <input type="text" class="form-control" id="nama" name="nama" value="{{$item->Nama_Siswa}}" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="tahun" id="tahun" class="form-control">
                  ...
                  <option value="{{$items->ID_Thn_Ajaran}}">{{$items->Thn_Ajaran}} - {{$items->Semester}}</option>
                  @endforeach
                </select>
            </div>
