...
@section('container')
    <!-- Page Heading -->
    <div class="edit text-sm-end"><a href="{{ route('tambahekskulsadmin') }}" type="button"
            ...
            <tbody>
                <tr>
                    @foreach ($ekstrakurikuler as $ekskul)
                        ...
                        <td><a type="button" href="{{ url('superadmin/editekskul', $ekskul->Kode_Ekskul) }}"
                            ...
                            <a type="button" href="" class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#exampleModal" data-ekskulid="{{ $ekskul->Kode_Ekskul }}"><i
