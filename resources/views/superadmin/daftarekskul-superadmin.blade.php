...
@section('container')
  <!-- Page Heading -->
  <div class="edit text-sm-end"><a href="{{route('tambahekskulsadmin')}}" type="button" class="btn btn-secondary mt-3 mb-3" ><i class="fa-solid fa-file-pen" style="color: #ffffff;"></i> Tambah  Ekstrakurikuler</a></div>
     ...
     <table  class="table text-center table-bordered  mt-4"style="width:950px ;" >
       ...
       <tbody>
            <tr>
             ...
             <td><a type="button" href="{{url('superadmin/editekskul', $ekskul->Kode_Ekskul)}}" class="btn btn-warning" ><i class="fa-solid fa-file-pen" style="color: #ffffff;"></i></a>
              <a type="button" href="" class="btn btn-warning"  data-bs-toggle="modal" data-bs-target="#exampleModal" data-ekskulid="{{ $ekskul->Kode_Ekskul }}"><i class="fa-solid fa-delete-left" style="color: #ffffff;"></i></a></td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/superadmin/deleteekskul/' + ekskulId;
            });
        });
    </script>
@endsection