...
@section('container')
    <!-- Page Heading -->
    <div class="edit text-sm-end"><a href="{{ route('tambahekskul') }}" type="button"
            ...
            <tbody>
                <tr>
                    @foreach ($ekstrakurikuler as $ekskul)
                        ...
                        <td><a type="button" href="{{ url('admin/editekskul', $ekskul->Kode_Ekskul) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/admin/deleteekskuls/' + ekskulId;
            });
        });
    </script>
@endsection
