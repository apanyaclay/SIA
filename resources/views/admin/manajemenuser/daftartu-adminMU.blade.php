...
@section('container')
    <div class="edit text-sm-end"><a type="button" href="{{ route('tambahtus') }}" class="btn btn-secondary mt-3 mb-3"><i
                class="fa-solid fa-file-pen" style="color: #ffffff;"></i>Tambah Tata Usaha</a></div>
            ...
            <tbody>
                @foreach ($tu as $tulist)
                    <tr>
                        ...
                        <td><a type="button" href="{{ url('admin/detailtu', $tulist->ID_Pegawai) }}"
                                class="btn btn-warning">Lihat Detail</a></td>
                        <td><a type="button" href="{{ url('admin/edittu', $tulist->ID_Pegawai) }}"
                            ...
                            <a type="button" href="" class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#exampleModal" data-ekskulid="{{ $tulist->ID_Pegawai }}"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/admin/deletetu/' + ekskulId;
            });
        });
    </script>
@endsection
