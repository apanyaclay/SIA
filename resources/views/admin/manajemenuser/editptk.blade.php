...
@section('container')
    ...
    <div class="informasi py-3 px-5">
        <form action="{{ route('editptksPost') }}" method="POST">
            @csrf
                ...
                @foreach ($data as $item)
                    <div class="form-group">
                        <tr>
                            ...
                            <td><input type="text" id="id" name="id" required value="{{ $item->NUPTK }}"
                                    readonly></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            ...
                            <td><input type="text" id="ids" name="ids" required value="{{ $item->NIP }}">
                            </td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                            ...
                            <td><input type="text" id="nama" name="nama" required value="{{ $item->Nama_Guru }}">
                            </td>
                        </tr>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td><input type="date" id="tmp_kerja" name="tmp_kerja" required
                                    value="{{ $item->TMT_Kerja }}"></td>
                        </tr>
                    </div>
                    <div class="form-group">
                        <tr>
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td><input type="number" id="jjm" name="jjm" required value="{{ $item->JJM }}">
                            </td>
                        </tr>
                    </div>
                    <div class="form-group">
